	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>Ashulia,Savar,Dhaka</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">aminul35-336@diu.edu.bd</a></p>
			</div>
		</div>
     ...
     <div>
     	<h1 style="text-align: center;">
     		Design and Developed By Aminul
     	</h1>
     </div>
	</footer>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            ...
				                            <label for="buyer">Agriculturist</label>
				                        </div>
									</div>
									<center>
									<div class="row uniform">
